...
alter table employee_details drop column e_gender,drop column e_birthdate;
select * from employee_details;
alter table employee_details rename column e_name to employee_name,rename column e_id to employee_id,rename column e_domain to employee_domain,rename column e_age to employee_age,rename column e_email to employee_email;
alter table employee_details modify column e_name bigint,modify column e_address bigint,modify column e_gender bigint,modify column e_emial bigint;
select * from employee_details;
